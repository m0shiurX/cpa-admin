        ...
        <div class="py-12">
            <div class="mx-auto max-w-screen-xl px-0">
                ...
                <div class="px-4 md:px-8 xl:px-10">
                    <div class="flex items-center justify-between">
                        <Link
                            ...
                            ><span class="text-sm font-medium leading-none text-white">Add user</span>
                        </Link>
                    </div>
                </div>
                <div class="rounded-lg px-4 md:px-8 xl:px-10">
                        ...
                        <table class="w-full table-auto whitespace-nowrap">
                            <thead>
                                <tr tabindex="0" class="h-16 rounded-lg border border-gray-100 bg-white text-lg text-gray-500 focus:outline-none">
                                    <th class="border-r border-gray-100 pl-5 text-left">Name</th>
                                    <th class="border-x border-gray-100 pl-5 text-left">Email</th>
                                    <th class="border-x border-gray-100 pl-5 text-left">Phone</th>
                                    ...
                                    >
                                        <td class="border-r border-gray-100">
                                            <div class="flex items-center pt-3 pl-5">
                                                <p class="mr-2 text-lg font-medium leading-none text-gray-700">{{ user.name }}</p>
                                            </div>
                                        </td>
                                        <td class="border-r border-gray-100">
                                            <div class="flex items-center pt-2 pb-3 pl-5">
                                                <p class="ml-1 truncate text-base leading-none text-gray-400">{{ user.email }}</p>
                                            </div>
                                        </td>
                                        <td class="border-r border-gray-100">
                                            <div class="flex items-center pt-2 pb-3 pl-5">
                                                <p class="ml-1 truncate text-base leading-none text-gray-400">{{ user.phone }}</p>
                                            </div>
                                        </td>
                                        <td class="w-48">
                                            <div class="flex items-center pt-2 pb-3 pl-5">
                    ...
                    <Pagination class="mt-5" :links="props.users.links" />
                </div>
            </div>
        </div>
    </BreezeAuthenticatedLayout>
